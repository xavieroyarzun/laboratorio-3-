...
public class Main
{
    public static class Game {
        ...
        public static void main(String[] args) {
            Game Ejemplo = new Game("Balatro", "rougelike", 9000, 95);
            System.out.println("Nombre: " + Ejemplo.getName());
            System.out.println("Categoría: " + Ejemplo.getCategory());
            System.out.println("Precio: " + Ejemplo.getPrice());
            System.out.println("Calidad: " + Ejemplo.getQuality());
           }
    }
    public class Dataset {
        ...
        public static void main(String[] args) {
            ...
            games.add(new Game("Balatro", "rougelike", 9090, 95));
            games.add(new Game("Borderlands2", "lootingshooter", 10990, 87));
            games.add(new Game("Metalgearsolid", "Estrategia", 19990, 90));
            games.add(new Game("portal2", "Aventura", 4990, 80));

            Dataset dataset = new Dataset(games);

            System.out.println("Ordenando por precio con mergeSort...");
            dataset.sortbyalgorithm("mergeSort", "price");

            System.out.println("Buscando juegos con precio 24990:");
            ArrayList<Game> result = dataset.getGamesByPrice(24990);
            for (Game game : result) {
                System.out.println(game.getName() + " - " + game.getPrice());
            }

            System.out.println("Buscando juegos entre 20000 y 30000:");
            result = dataset.getGamesByPriceRange(20000, 30000);
            for (Game game : result) {
                System.out.println(game.getName() + " - " + game.getPrice());
            }
        }
